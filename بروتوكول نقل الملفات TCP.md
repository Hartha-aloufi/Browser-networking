...
وذلك يعني أن المرسل يستطيع ارسال اربعة اقطاع بيانية (TCP Segment) وبعدها عليه التوقف الى حين وصول تاكيد الاستلام. وعند استلام التأكيد تقوم خوارزمية "البداية ببطء" بزيادة قيمة متغير نافذة الاحتقان cwnd بمقدار 1 لكل تأكيد استلام حزمة بيانات, وهذا يعني أن لدينا نمواً أُسياً لحجم نافذة الاحتقان. 
...
معرفة تفاصيل هذه الخوارزمية مهم جداً, وذلك لأنها تطبق على جميع الاتصالات المعتمدة على بروتوكول النقل TCP والذي هو عماد بروتوكول الـ HTTP, عِمادُ تطبيقات الويب. وهذا يقودنا لاستنتاج مهم, وهو أننا لا نستطيع استخدام كامل قدرة الشبكة مباشرةً, بل نحتاج لبعض الوقت حتى نصل الى القيمة الأفضل لمتغير نافذة الاحتقان rwnd. هذا الأمر لا يعد مشكلة للاتصالات الطويلة عند نقل بيانات كبيرة كتحميل الملفات وبث المرئيات, حيث أن عدد الدورات (Round trip) اللازمة للوصول الى القيمة المثلى لا تعد شيءً نسبةً الى عدد دورات الاتصال كاملةً. وكلنه يعد مشكلة كبيرة بالنسبة للاتصالات القصيرة والسريعة والتي هي عملياً أغلب اتصالات الـ HTTP, فينتهي الاتصال قبل أن نصل الى القيمة المثلى لنافذة الاحتقان. وهذا يحد من كفائة استخدامنا لقدرات الشبكة وبطء أداء التطبيقات.



#### اعادة البداية ببطء (Slow-Start Restart SSR)

هي ميزة مطبقة في برتوكول الـ TCP تقوم باعادة تهيئة قيمة نافذة الاحتقان rwnd للاتصالات الخاملة بعدة مدة محددة. المنطق وراء هذا الميزة بسيط, وهو أن حال الشبكة يمكن أن يكون قد تغير اثناء خمول الاتصال, ولتفادي الاتقان سنعيد تهيئة النافذة بقيمتها الافتراضية.

من غير المفاجئ أن تعلم أن هذه الميزة لديها تأثير سيئ وقوي على اتصالات الـ TCP الطويلة مثل اتصالات الـ HTTP Keep-alive. ولهذا ينصح بايقاف هذه الميزة على الخوادم. يمكن الوصول الى اعددات الـ SSR وتعديلها على نظام اللينكس من خلال هذين الأمرين:
